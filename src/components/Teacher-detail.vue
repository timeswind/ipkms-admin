...
export default {
  attached () {
    var teacher_id = this.$route.params.teacher_id
    this.getStudentDetail(teacher_id)
  },
  data () {
    return {
      results: {
  ...
  methods: {
    getTeacherDetail: function (teacher_id) {
      if (student_id) {
        var apiURL = '/api/manage-account/teachers/' + teacher_id
    ...
    updateTeacher: function () {
      var teacher_id = this.$route.params.student_id
